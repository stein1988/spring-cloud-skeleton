  ...
  <div class="role-management">
    ...
    <el-dialog v-model="detailVisible" title="角色详情" width="500px">
      <el-descriptions :column="1" border v-if="currentRole">
        ...
        <el-descriptions-item label="创建时间">{{ currentRole.createdAt }}</el-descriptions-item>
        <el-descriptions-item label="更新时间">{{ currentRole.updatedAt }}</el-descriptions-item>
      </el-descriptions>
    </el-dialog>
  </div>
</template>
    ...
    if (valid) {
      ...
      try {
        if (dialogType.value === 'create') {
          ...
          await roleApi.update(currentRole.value.id, form)
